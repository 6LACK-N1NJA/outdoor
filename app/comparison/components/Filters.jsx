...
export default function Filters({ filters, filtersConfig, selectedFilters, title }) {
  ...
  return (isExpanded ? 
    ...
    >
        ...
        <div className='jalousie-content'>
                {filters.map(({ title, slug }) => <p className='ml-7 jalousie-content-opacity' key={`${slug}_filter`}>
